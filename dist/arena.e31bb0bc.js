...
if (!slug) {
  ...
  window.location.hash = "#".concat(slug);
}

var useLoadChannel = function useLoadChannel(setChannel) {
  return (0, _react.useEffect)(function () {
    fetch("http://api.are.na/v2/channels/".concat(slug)).then(function (response) {
      return response.json();
    }).then(function (json) {
      return {
        title: json.title,
        images: json.contents.map(function (imageContent) {
          return {
            id: imageContent.id,
...
var App = function App() {
  ...
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("h1", null, channel.title), channel.images.map(function (_ref) {
    var id = _ref.id,
        src = _ref.src;
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "52864" + '/');
...
//# sourceMappingURL=arena.e31bb0bc.map